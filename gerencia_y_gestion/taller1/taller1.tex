...
\section{Análisis de Buenas Prácticas: Contrato SA-MEN-05-2022}
    ...
    El contrato \textbf{SA-MEN-05-2022} (Ministerio de Educación Nacional) se destaca como un referente positivo de gestión. Del análisis de los documentos en SECOP y la teoría general sobre contratación estatal exitosa, se extraen las siguientes buenas prácticas:

    \subsection{Planificación y Estudios Previos Rigurosos}
    La documentación resalta una solidez notable en los estudios previos. El análisis exhaustivo de mercado permitió estructurar un presupuesto realista, definiendo requerimientos técnicos alcanzables y disminuyendo la incertidumbre antes de abrir la licitación, asegurando proyectos de infraestructura educativa viables. Adicionalmente, contar con diseños definitivos y especificaciones técnicas detalladas (una de las prácticas más recomendadas en gestión de proyectos públicos) es fundamental, ya que garantiza el principio de economía y optimiza la ruta crítica.

    \subsection{Gestión de Riesgos y Pólizas}
    La matriz de riesgos del proyecto estuvo bien estructurada, con una distribución equitativa de las cargas entre la entidad contratante y el contratista. Se dispusieron pólizas adecuadas para cubrir aspectos esenciales de cumplimiento, pago de salarios y estabilidad de la obra civil. Una correcta asignación y tipificación de riesgos previene reclamaciones futuras y facilita la resolución de sobrecostos imprevistos.

    \subsection{Transparencia y Criterios Claros de Adjudicación}
    Los pliegos de condiciones se diseñaron garantizando la pluralidad de oferentes mediante puntajes sensatos, evitando "pliegos sastre" o direccionamientos contractuales indebidos. La publicación oportuna de la documentación complementaria y respuestas a las observaciones de los proponentes robusteció el principio de selección objetiva, estimulando una sana competencia.

\section{Análisis de Malas Prácticas: Contrato IDU-1635-2019}

    En contraste, el contrato \textbf{IDU-1635-2019} (cuyo objeto contemplaba el mantenimiento, rehabilitación y reconstrucción de espacio público y ciclorrutas del Grupo F), centrado en el desarrollo de obra pública en Bogotá (Instituto de Desarrollo Urbano), ejemplifica una cadena de anomalías y malas prácticas de contratación confirmadas por entes de control:
    ...
    \subsection{Debilidades en la Interventoría y en los Procesos Sancionatorios}
    En auditorías se ha demostrado la falta de articulación entre los consorcios de obra civil y la interventoría para ejecutar planes de contingencia oportunos y recuperar los retrasos en la ruta crítica del cronograma planificado. A lo anterior se suma lo documentado por la Contraloría de Bogotá (Informe Final de Auditoría de Desempeño, Código 118, PAD 2020), donde se determinó un hallazgo administrativo debido a la falta de oportunidad del IDU para aplicar los procesos sancionatorios pertinentes ante los presuntos incumplimientos del contratista. Esta omisión del control administrativo derivó en que no se cumpliera el objeto de la obra en los tiempos iniciales (establecidos a 10 meses) e incrementó las numerosas actas de suspensión suscritas.
